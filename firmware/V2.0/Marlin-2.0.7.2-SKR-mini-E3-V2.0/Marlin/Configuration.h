...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 18.90
  #define DEFAULT_bedKd 342.12
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.5, -10, -1.88 }
...
// Feedrate (mm/min) for the first approach when double-probing (j_PROBING == 2)
